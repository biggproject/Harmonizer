...
from ontology.bigg_classes import Device, UtilityPointOfDelivery, LocationInfo, BuildingSpace
...
class Mapper(object):
    ...
    def get_mappings(self, group):
        ...
        device = {
            ...
            "params": {
                "raw": {
                    "hasDeviceType": to_object_property("Meter.EnergyMeter.Electricity", bigg_enums)
                },
                "mapping": {
                    "subject": {
                        "key": "device_uri",
